...
st.markdown("<style>div.block-container{padding-top:32px;}</style>",unsafe_allow_html=True)
...
if fl is not None:
    ...
    os.chdir(r"C:\Users\Dell\Desktop\kalki")   
    df=pd.read_csv("Sales.csv",encoding="ISO-8859-1",sep=",")

#importing calender for date selection
...
with cl1:
    with st.expander("Category_ViewData"):
        ...
        st.download_button("Download Data",data=csv,file_name="Category.csv",
                    mime="text/csv",help="Click here to download the data as CSV file")
